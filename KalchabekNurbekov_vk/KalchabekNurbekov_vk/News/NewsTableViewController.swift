...
class NewsTableViewController: UITableViewController {
    ...
    let myPosts = [
        ...
        Post(postAvatar: UIImage(named: "vacuum")!, postName: "VACUUM", postDate: "today at 00:06", postText: "Для любого человека понятие «дом» значит гораздо больше, чем толкование в массивных словарях или современной Википедии. Это не только жилище, где можно поесть, поспать, принять душ и посмотреть телевизор. ", postImage: UIImage(named: "House")!),
